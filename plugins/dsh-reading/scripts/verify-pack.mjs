...
const directory = await mkdtemp(join(tmpdir(), 'dsh-reading-pack-'))
try {
  ...
  for (const required of ['package/lib/index.js', 'package/lib/client.js', 'package/lib/types/index.d.ts', 'package/cordis.patch.yml']) {
