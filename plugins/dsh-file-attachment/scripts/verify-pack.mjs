...
try {
  ...
  for (const required of [
    'package/lib/index.js', 'package/lib/client.js', 'package/lib/types/index.d.ts',
    'package/lib/types/client/index.d.ts', 'package/cordis.patch.yml', 'package/README.md', 'package/LICENSE',
  ]) {
